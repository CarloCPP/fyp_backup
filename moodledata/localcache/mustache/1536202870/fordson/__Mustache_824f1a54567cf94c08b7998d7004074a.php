...
class __Mustache_824f1a54567cf94c08b7998d7004074a extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section45dc85eb0f5018f6ee01eade862f7bc3($context, $indent, $value);
...
';
    ...
    private function section156a9c25c9f1e9c63d82b3a7cb6fee6c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionCe2216c1d8e3c1884146f6b974dd5972(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section156a9c25c9f1e9c63d82b3a7cb6fee6c($context, $indent, $value);
                $context->pop();
            }
        }
    ...
    private function sectionE553d66471cf5fc4ca078d043136dc23(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section3b1429d37c965adbe98c4687fa9af709(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                            <p>';
                $value = $this->resolveValue($context->find('myprogresstext'), $context);
                $buffer .= $value;
                $buffer .= '</p>
';
                $buffer .= $indent . '                            ';
                $value = $this->resolveValue($context->find('progresschart'), $context);
                $buffer .= $value;
                $buffer .= '
';
                $context->pop();
    ...
    private function section602648af0d69778b723ed26f49035d4f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
                    <div class="col-md-2 studentcompletion">
                        {{#progresschart}}
                            <p>{{{myprogresstext}}}</p>
                            {{{progresschart}}}
                        {{/progresschart}}
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '                    <div class="col-md-2 studentcompletion">
';
                // 'progresschart' section
                $value = $context->find('progresschart');
                $buffer .= $this->section3b1429d37c965adbe98c4687fa9af709($context, $indent, $value);
                $buffer .= $indent . '                    </div>
';
                $context->pop();
            }
...
';
    ...
    private function section8898ffadc4890951e7eeacc691099609(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionE553d66471cf5fc4ca078d043136dc23($context, $indent, $value);
                $buffer .= $indent . '
';
                // 'hascompletionshow' section
                $value = $context->find('hascompletionshow');
                $buffer .= $this->section602648af0d69778b723ed26f49035d4f($context, $indent, $value);
                $buffer .= $indent . '
';
...
';
    ...
    private function section45dc85eb0f5018f6ee01eade862f7bc3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->sectionCe2216c1d8e3c1884146f6b974dd5972($context, $indent, $value);
                $buffer .= $indent . '
';
                $buffer .= $indent . '
';
                ...
                $buffer .= $this->section8898ffadc4890951e7eeacc691099609($context, $indent, $value);
