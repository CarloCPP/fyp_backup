...
class __Mustache_360c9b5f69c8fb937d1c4f31d48034b3 extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->sectionE73736448e30e3a68bb48db12f5153e3($context, $indent, $value);
        }
        $buffer .= '
';
...
';
        $buffer .= $indent . '        </span>
';
        $buffer .= $indent . '         <div class="form-control-feedback invalid-feedback" id="id_error_';
        $value = $this->resolveValue($context->findDot('element.name'), $context);
        $buffer .= call_user_func($this->mustache->getEscape(), $value);
        $buffer .= '" ';
        // 'error' section
...
';
    ...
    private function sectionF09516e06e9b65f3b339bb6a4b710a6e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionE73736448e30e3a68bb48db12f5153e3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                // 'element.checked' section
                $value = $context->findDot('element.checked');
                $buffer .= $this->sectionF09516e06e9b65f3b339bb6a4b710a6e($context, $indent, $value);
                $context->pop();
            }
        }
