...
class __Mustache_7f26d637dadb9e63e93ccf7f0e2bc1a2 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <div class="row m-b-2">
';
...
';
        $buffer .= $indent . '        <div class="col-xs-6 span6">
';
        $buffer .= $indent . '            <input type="checkbox" class="mastercheck m-r-1" aria-label="';
        // 'str' section
        $value = $context->find('str');
...
';
        ...
        $buffer .= $this->section9a958b88e7e3c17f82e9d5064ce29b00($context, $indent, $value);
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function section57d0d86b4fdc7b0dd7f0d882470908f3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '             <div class="m-b-1">
';
                $buffer .= $indent . '                <div class="row m-b-1 row-fluid">
';
                $buffer .= $indent . '                    <div class="col-xs-6 span6">
';
...
';
                ...
                $value = $this->resolveValue($context->find('id'), $context);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '" type="checkbox" class="m-r-1" name="modids[]" value="';
                $value = $this->resolveValue($context->find('id'), $context);
                $buffer .= call_user_func($this->mustache->getEscape(), $value);
                $buffer .= '" aria-label="';
                // 'str' section
...
';
                $buffer .= $indent . '                    </div>
';
                $buffer .= $indent . '                    <div class="activity-completionstatus col-xs-6 span6">
';
                $buffer .= $indent . '                        <div class="col-sm-1 span1 p-l-0">
';
                ...
                if (empty($value)) {
                    ...
                    $buffer .= $indent . '                                <span class="m-r-3"></span>
';
                }
                $buffer .= $indent . '                        </div>
';
                $buffer .= $indent . '                        <div class="col-sm-11 span11 p-l-0">
';
...
';
    ...
    private function section9a958b88e7e3c17f82e9d5064ce29b00(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section57d0d86b4fdc7b0dd7f0d882470908f3($context, $indent, $value);
                $context->pop();
            }
        }
