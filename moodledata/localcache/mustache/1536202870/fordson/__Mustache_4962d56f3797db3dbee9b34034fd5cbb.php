...
class __Mustache_4962d56f3797db3dbee9b34034fd5cbb extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section0e03cea72487cbfdf525cd057b3658f6($context, $indent, $value);
        $buffer .= $indent . '</div>
';
        $buffer .= $indent . '
';
...
';
    ...
    private function section0e03cea72487cbfdf525cd057b3658f6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
