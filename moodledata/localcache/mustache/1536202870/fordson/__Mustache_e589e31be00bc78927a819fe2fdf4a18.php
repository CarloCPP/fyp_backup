...
class __Mustache_e589e31be00bc78927a819fe2fdf4a18 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionCed38491fe5a9764ff8d8059f5a469ae($context, $indent, $value);
        $buffer .= $indent . '
';
        $buffer .= $indent . '
';
        ...
        $buffer .= $this->section7ea5c98eedcc722d4acb4c0553197487($context, $indent, $value);
        $buffer .= $indent . '
';
        // 'js' section
...
';
    ...
    private function section8a823a5850bf9dfd4ce29b5edb3c2606(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionCed38491fe5a9764ff8d8059f5a469ae(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section8a823a5850bf9dfd4ce29b5edb3c2606($context, $indent, $value);
                $buffer .= $indent . '            </div>
';
                $buffer .= $indent . '    </div>
';
...
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '    <div class="col-xl-7 push-xl-1 col-md-8">
';
...
';
    ...
    private function section194bee0613b21027a38addd6d2b9b63e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionFf57e9891e98b82279f1b965a587a3a3(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section7ea5c98eedcc722d4acb4c0553197487(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                // 'logourl' section
                $value = $context->find('logourl');
                $buffer .= $this->section194bee0613b21027a38addd6d2b9b63e($context, $indent, $value);
                // 'logourl' inverted section
                $value = $context->find('logourl');
                if (empty($value)) {
...
';
                // 'canloginasguest' section
                $value = $context->find('canloginasguest');
                $buffer .= $this->sectionFf57e9891e98b82279f1b965a587a3a3($context, $indent, $value);
                $buffer .= $indent . '
';
                // 'hasidentityproviders' section
                $value = $context->find('hasidentityproviders');
